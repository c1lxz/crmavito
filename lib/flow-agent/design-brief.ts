...
export function buildPromptFromBrief(
  ...
  return [
    ...
    "The design must read as a specific intentional editorial idea, never as random squares, rectangles, grids, color fields, stock clipart, a logo exercise or a generic animal mascot. No animals, stars, horse, buffalo, yak, bear, wolf, wings, skull, compass or crest.",
...
function designDirectorPrompt(
  ...
  return [
    ...
    "The concept needs one recognizable editorial subject and a clear story grounded in the inspected alternative-rockstar demand. Distressed portraits/figures, lips, eyes, crosses, spiders, wings, skulls, message graphics or adjacent grammar are allowed only when supported by the actual references. Ban random abstract squares/rectangles/grids, decorative color blocks, arbitrary geometry, generic animals, the winner's stars and horse/buffalo/yak/bear/wolf artwork, a lone chest logo and copied brand wording.",
    "Use the winner's commercial logic but invent a different subject, silhouette, wording and composition. Front and back must be distinct but clearly coordinated. The front is a restrained secondary hook; the back carries the hero artwork. Never put the same principal object, figure, hand, face, symbol or silhouette on both sides, even at a different scale or crop.",
