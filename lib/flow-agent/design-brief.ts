...
const BANNED_CREATIVE_MOTIF = /\b(?:animal|animals|bird|birds|owl|owls|eagle|eagles|raven|ravens|crow|crows|bison|buffalo|yak|horse|equine|stallion|bull|cow|wolf|bear|tiger|lion|panther|snake|serpent|dragon|butterfl(?:y|ies)|spider|insect|mascot|creature|moon|crescent|zodiac|tarot|astrology|celestial|botanical|flower|floral|herbarium|branch|branches|kawaii|cute|cartoon)\b/i;
...
function designDirectorPrompt(
  ...
  return [
    ...
    "HARD SUBJECT BAN: no animals, birds, insects, owls, mascots, fantasy creatures, moon/crescent/zodiac/tarot imagery, flowers, botanical branches, cute faces, cartoons or children's-merch storytelling, even if a reference contains them. Never replace a banned subject with a different creature, mystical icon or soft nature illustration.",
