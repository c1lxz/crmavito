...
import { createKlingContentMachineJob } from "@/lib/ai/kling-content-machine-jobs";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ job: await createKlingContentMachineJob(products, imageSize) });
  } catch (error) {
