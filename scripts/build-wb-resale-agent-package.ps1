...
robocopy $rpaSrc $rpaDst /E /XD node_modules .browser-profile .browser-profile-yandex .browser-profile-chrome .browser-profile-edge .browser-profile-firefox photos remote-photos logs test-results playwright-report /XF items.csv *.log | Out-Null
if ($LASTEXITCODE -gt 7) {
